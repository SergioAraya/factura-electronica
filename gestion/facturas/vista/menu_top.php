...
<ul class="nav nav-pills" role="tablist">
    ...
    <li role="presentation"><a href="pdf.php?p=facturas&c=pdf&facturas_id=<?php echo $facturas_id; ?>&metodo=pdf"><span class="glyphicon glyphicon-print"></span> <?php _t("Imprimir"); ?></a></li>
