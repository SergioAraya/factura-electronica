...
<?php _t("Editar"); ?></h2> 
 ...
 <?php 
                        $campos = array(array(
"type" => "text",
"name" => "notac_items_ref_notac",
"value" => "$notac_items_ref_notac",                                                                        
    
"for" => "notac_items_ref_notac",
"label" => "ref_notac",
"class" => "form-control",
"id" => "notac_items_ref_notac",
"placeholder" => "ref_notac",
                    ),array(
"type" => "text",
"name" => "notac_items_cantidad",
"value" => "$notac_items_cantidad",                                                                        
    
"for" => "notac_items_cantidad",
"label" => "cantidad",
"class" => "form-control",
"id" => "notac_items_cantidad",
"placeholder" => "cantidad",
                    ),array(
"type" => "text",
"name" => "notac_items_descripcion",
"value" => "$notac_items_descripcion",                                                                        
    
"for" => "notac_items_descripcion",
"label" => "descripcion",
"class" => "form-control",
"id" => "notac_items_descripcion",
"placeholder" => "descripcion",
                    ),array(
"type" => "text",
"name" => "notac_items_valor",
"value" => "$notac_items_valor",                                                                        
    
"for" => "notac_items_valor",
"label" => "valor",
"class" => "form-control",
"id" => "notac_items_valor",
"placeholder" => "valor",
                    ),array(
"type" => "text",
"name" => "notac_items_porcentaje_iva",
"value" => "$notac_items_porcentaje_iva",                                                                        
    
"for" => "notac_items_porcentaje_iva",
"label" => "porcentaje_iva",
"class" => "form-control",
"id" => "notac_items_porcentaje_iva",
